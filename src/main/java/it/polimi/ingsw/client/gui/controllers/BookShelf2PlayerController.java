...
/**
 * The BookShelf2PlayerController class extends the BookShelfSceneController class
 * and controls the bookshelf scene for two opponent players.
 *
...
public class BookShelf2PlayerController extends BookShelfSceneController {
    ...
    /**
     * Sets the view of the bookshelf scene for two players.
